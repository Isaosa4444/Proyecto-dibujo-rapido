...
document.getElementById("trazado").innerHTML="dibujo a ser trazado: "+ skecth;
...
function draw() {
    ...
    checkSketch();
    if(draw_sketch==skecth){
        answer_holder="set";
        score++;
        document.getElementById("puntuacion").innerHTML="Puntuacion: "+ score;
    }
}
...
function gotResult(error, results){
    ...
    document.getElementById("dibujo").innerHTML="Tu dibujo es: "+ draw_sketch;
    document.getElementById("confianza").innerHTML="La confianza es de: "+ Math.round(results[0].confidence*100)+ "%";
}
